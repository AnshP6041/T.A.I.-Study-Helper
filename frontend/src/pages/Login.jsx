...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-blue-50 flex">
            <form onSubmit={handleLogin} className={"max-w-md m-auto my-12 p-12 bg-blue-200 rounded-4xl max-h-fit"}>
                <div>
                ...
                <h1 className="mt-3 text-center text-xl font-mono font-semibold">Log In</h1>
                <p className={"text-center mt-1"}>Don't have an account? <Link to={"/register"} className={"text-blue-500 focus:opacity-50"}>Register!</Link></p>
